...
package org.apache.sysds.hops.codegen.cplan.llvm;
...
public class CellWise implements CodeTemplate {
	...
	private static final String TEMPLATE_PATH = "";  // TODO:  path to LLVM cellwise template string file
	...
	public String getTemplate(SpoofCellwise.CellType ct) {
		try {
			...
			if(org.apache.sysds.hops.codegen.cplan.llvm.CellWise.class.getProtectionDomain().getCodeSource().getLocation().getPath().contains(".jar"))
